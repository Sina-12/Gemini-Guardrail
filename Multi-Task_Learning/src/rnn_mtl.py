"""
Neural multi-task model for Sprint 3.

This file builds a multi-task version of the Sprint 2 neural transfer model.
The model predicts a joint label made from the primary `accuracy` annotation
and the auxiliary `brevity` annotation and and then converts the joint 
prediction back into the main accuracy label for evaluation
"""
...
OUT_PATH = DATA_DIR / "rnn_mtl_predictions.csv"
RANDOM_SEED = 123


def main():
    """
    Train and evaluate the neural Sprint 3 multi-task model.
    ...
    print("Neural multi-task model: SVD(TF-IDF) + GloVe + MLP")
